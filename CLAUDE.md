...
`docs/geometry.md` (геометрия платформы + логика перехвата замков для кросс-рядных операций, замеры 08.06.2026),
`docs/FLOWS.md` (сквозной разбор флоу выдачи/возврата/библиотекаря),
