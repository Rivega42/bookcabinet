unit RRU9816_DLL_Head;

interface

Const
    RRU9816_DLLName = 'RRU9816.dll'; 
...
type
    RTempRecord=Record
     ...
     Function OpenNetPort(Port : LongInt;
                    IPaddr:string;
                     var ComAdr : byte;
                     var frmcomportindex:longint): LongInt; stdcall;external RRU9816_DLLName ;
    Function CloseNetPort( frmComPortindex : longint ): LongInt; stdcall; external RRU9816_DLLName ;
    Function OpenUSBPort(var ComAdr : byte;
                     var frmcomportindex:longint): LongInt; stdcall;external RRU9816_DLLName ;
    Function CloseUSBPort( frmComPortindex : longint ): LongInt; stdcall; external RRU9816_DLLName ;

    Function OpenComPort(Port : LongInt;
                          var ComAdr : byte;
                          Baud:byte;
                          var frmcomportindex: longint): LongInt;
                          stdcall; external RRU9816_DLLName ;
